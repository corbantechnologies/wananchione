...
export default function GLAccountReferencePage() {
    ...
    const filteredEntries = useMemo(() => {
        ...
        return account.entries.filter(entry => 
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-2xl  text-slate-900 font-mono er">
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-2xl  text-slate-900 er capitalize">
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-2xl  text-emerald-600 font-mono er">
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-2xl  text-rose-600 font-mono er">
            ...
            <Card className="border-none shadow-sm bg-white rounded-lg">
                <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 border-b">
                    <div className="space-y-1">
                        ...
                        <CardDescription>
                            All journal entries impacting this account
                        </CardDescription>
                    </div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-slate-50/50 hover:bg-slate-50/50">
                                ...
                                <TableHead className="text-[10px]  text-slate-500 uppercase tracking-wider py-4 text-right pr-6">CREDIT</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
