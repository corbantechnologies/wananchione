                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-3 mb-1">
                            <h1 className="text-lg font-bold text-gray-900">{venture.venture_type}</h1>
                            <Badge variant={venture.is_active ? 'default' : 'secondary'}
                                className={venture.is_active ? 'bg-[#174271]' : ''}>
                    ...
                    <div className="flex gap-3">
                        <Button className="bg-[#174271] hover:bg-[#034625]" onClick={() => setPaymentModal(true)}>
                            Make Payment
                        </Button>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    {activeTab === 'overview' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-[#174271]">Account Overview</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="flex justify-between py-2 border-b">
                                        <span className="text-muted-foreground">Current Balance</span>
                                        <span className="font-bold text-lg text-[#174271]">{formatCurrency(venture.balance)}</span>
                                    </div>
                                    <div className="flex justify-between py-2 border-b">
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-[#174271]">Account Details</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="flex justify-between py-2 border-b">
                                            ...
                                            <TableRow key={i}>
                                                ...
                                                <TableCell>
                                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                                                        ${t.type === 'Payment' ? 'bg-blue-100 text-blue-800' : 'bg-[#D4AF37] text-[#D4AF37]'}`}>
                                                        {t.type}
                                                    </span>
                                                </TableCell>
